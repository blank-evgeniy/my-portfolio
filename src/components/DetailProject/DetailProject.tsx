...
const DetailProject: React.FC<DetailProjectProps> = ({project, setActive}) => {
    const path = './projects/';

    return (
        <div className='detail-project'>
            <button className='detail-project__close' onClick={() => setActive(false)}><IoClose size={'48px'}/></button>
